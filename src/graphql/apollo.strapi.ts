...
/**
 * __useTopbarAlertQuery__
 *
 * To run a query within a React component, call `useTopbarAlertQuery` and pass it any options that fit your needs.
 * When your component renders, `useTopbarAlertQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useTopbarAlertQuery({
 *   variables: {
 *   },
 * });
 */
export function useTopbarAlertQuery(
  ...
  return Apollo.useQuery<TopbarAlertQuery, TopbarAlertQueryVariables>(
    TopbarAlertDocument,
    options,
  );
}
export function useTopbarAlertLazyQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<TopbarAlertQuery, TopbarAlertQueryVariables>(
    TopbarAlertDocument,
    options,
  );
}
export type TopbarAlertQueryHookResult = ReturnType<typeof useTopbarAlertQuery>;
export type TopbarAlertLazyQueryHookResult = ReturnType<
  typeof useTopbarAlertLazyQuery
>;
