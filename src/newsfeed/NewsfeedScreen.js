...
class NewsfeedScreen extends Component {
   ...
   */
  componentDidMount() {
    this.disposeTabPress = this.props.navigation.addListener('tabPress', this.refreshNewsfeed);
  ...
  render() {
    ...
    return (
      <View style={CommonStyle.flexContainer} testID="NewsfeedScreen">
        <TopbarNewsfeed title={i18n.t('tabTitleNewsfeed')} navigation={this.props.navigation} refreshFeed={this.refreshNewsfeed}/>
        { feed }
