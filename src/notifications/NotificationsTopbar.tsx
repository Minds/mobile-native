...
export default class NotificacionsTopbar extends Component {
  ...
  render() {
    ...
    const bstyle = {
      borderBottomColor: ThemedStyles.getColor('primary_background'),
    };
        ...
        <View style={styles.topbar}>
          <View style={[styles.tab, bstyle, this.selected('all')]}>
            <Icon
              ...
              onPress={() => this.props.notifications.setFilter('all')}
            />
          </View>
          <View style={[styles.tab, bstyle, this.selected('tags')]}>
            <Icon
              ...
              onPress={() => this.props.notifications.setFilter('tags')}
            />
          </View>
          <View style={[styles.tab, bstyle, this.selected('comments')]}>
            <MIcon
              ...
              onPress={() => this.props.notifications.setFilter('comments')}
            />
          </View>
          <View style={[styles.tab, bstyle, this.selected('boosts')]}>
            <Icon
              ...
              onPress={() => this.props.notifications.setFilter('boosts')}
            />
          </View>
          <View style={[styles.tab, bstyle, this.selected('votes')]}>
            <IonIcon
              ...
              onPress={() => this.props.notifications.setFilter('votes')}
            />
          </View>
        </View>
      </View>
