...
const migrations = [
  ...
  'CREATE TABLE IF NOT EXISTS seen_portrait_entities ( urn VARCHAR(255) NOT NULL PRIMARY KEY, updated INTEGER )',
  'CREATE INDEX seen_portrait_entities_updated ON seen_portrait_entities(updated);',
];
