  ...
  <head>
    ...
    <style>
      ...
      @font-face {
        ...
        font-weight: 400;
        font-display: swap;
        src: local("Roboto"), local("Roboto_400Regular"), url("https://minds.com/static/assets/fonts/roboto/regular-latin.woff2") format("woff2");
        src: local("Roboto"), local("Roboto_400Regular"), url("https://minds.com/static/assets/fonts/roboto/regular-latin.woff") format("woff");
