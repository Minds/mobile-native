...
export default class WalletOnboardingFinishedScreen extends Component {
  ...
  render() {
    return (
      <View>
        <Text style={style.h1}>{i18n.t('wallet.onboarding.yourAreReady')}</Text>

        <Text style={style.p}>
          {i18n.t('wallet.onboarding.readyDescription1')}
        </Text>

        <Text style={style.p}>
          {i18n.t('wallet.onboarding.readyDescription2', null, {tokens:<Text style={style.b}>Tokens 101</Text>})}
        </Text>
        ...
        <View style={style.vertButtonBar}>
          <TransparentButton
            ...
            title={i18n.t('wallet.onboarding.moreOnRewards')}
          ...
          <TransparentButton
            ...
            title={i18n.t('wallet.onboarding.moreAboutWire')}
            color={Colors.darkGreyed}
          />
          ...
          <TransparentButton
            ...
            title={i18n.t('wallet.onboarding.moreAboutBoost')}
            color={Colors.darkGreyed}
          />
        </View>
      </View>
