  ...
  render() {
    return (
      <View>
        ...
        <Text style={style.p}>{i18n.t('onboarding.readyDescription1')}</Text>

        <Text style={style.p}>
          {i18n.t('onboarding.readyDescription2', null, {
            tokens: <Text style={style.b}>Tokens 101</Text>,
          })}
        </Text>
        ...
        <View style={style.vertButtonBar}>
          <TransparentButton
            ...
            onPress={() => {
              Linking.openURL('https://www.minds.com/wallet/tokens/101');
            }}
          ...
          <TransparentButton
            style={style.vertButton}
            onPress={() => {
              Linking.openURL('https://www.minds.com/faq/wire');
            }}
          ...
          <TransparentButton
            style={style.vertButton}
            onPress={() => {
              Linking.openURL('https://www.minds.com/faq/boost');
            }}
