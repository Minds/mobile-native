...
class NewsfeedFilters extends Component {
  ...
  render() {
    ...
    const disableHotLatest =
      store.type === 'channels' || store.type === 'groups';
      ...
      <View style={CS.rowJustifyStart}>
        <TouchableOpacity
          style={[
            ...
            CS.paddingLeft2x,
            CS.paddingRight2x,
            hashActive ? CS.backgroundPrimary : themed.backgroundTertiary,
          ...
          <View style={[CS.rowJustifyStart, CS.centered]}>
            <IconMC
              ...
              style={[
                CS.centered,
                hashActive ? themed.colorWhite : themed.colorTertiaryText,
                { paddingTop: 2 },
              ]}
              size={20}
            />
            {this.props.hashtag.hashtag ? (
              <Text style={[CS.colorWhite, CS.fontM]}>
                {this.props.hashtag.hashtag}
              </Text>
            ) : null}
          </View>
        ...
        <View style={[CS.rowJustifySpaceEvenly, CS.flexContainer]}>
          ...
          <View style={CS.rowJustifyCenter}>
            <TouchableOpacity
              style={[CS.padding]}
              onPress={() => store.setFilter('top')}
              {...testID('Filter top button')}>
              <View style={[CS.rowJustifyCenter, CS.centered]}>
                <Icon
                  name="trending-up"
                  style={[
            ...
            {store.filter == 'top' && (
              <Menu
                ...
                <MenuItem onPress={this.setPeriod12}>
                  {i18n.t('newsfeedFilters.topPeriod12')}
                </MenuItem>
                <MenuItem onPress={this.setPeriod24}>
                  {i18n.t('newsfeedFilters.topPeriod24')}
                </MenuItem>
                <MenuItem onPress={this.setPeriod7}>
                  {i18n.t('newsfeedFilters.topPeriod7')}
                </MenuItem>
                <MenuItem onPress={this.setPeriod30}>
                  {i18n.t('newsfeedFilters.topPeriod30')}
                </MenuItem>
