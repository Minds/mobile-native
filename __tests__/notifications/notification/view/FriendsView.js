...
import FriendsView from '../../../../src/notifications/notification/view/FriendsView';
...
it('renders correctly', () => {
  ...
  const entity = boostNotificationFactory('friends');

  const notification = renderer.create(
    <FriendsView styles={styles} entity={entity}/>
  ).toJSON();
