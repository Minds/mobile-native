...
import CommentView from '../../../../src/notifications/notification/view/CommentView';
...
it('renders correctly', () => {
  ...
  const entity = boostNotificationFactory('comment');

  const notification = renderer.create(
    <CommentView styles={styles} entity={entity}/>
  ).toJSON();
