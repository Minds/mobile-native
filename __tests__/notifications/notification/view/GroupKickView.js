...
import GroupKickView from '../../../../src/notifications/notification/view/GroupKickView';
...
it('renders correctly', () => {
  ...
  const entity = boostNotificationFactory('group_kick');

  const notification = renderer.create(
    <GroupKickView styles={styles} entity={entity}/>
  ).toJSON();
