...
import GroupInviteView from '../../../../src/notifications/notification/view/GroupInviteView';
...
it('renders correctly', () => {
  ...
  const entity = boostNotificationFactory('group_invite');

  const notification = renderer.create(
    <GroupInviteView styles={styles} entity={entity}/>
  ).toJSON();
